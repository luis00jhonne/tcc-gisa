...
public class TrabalhadorDTO extends RepresentationModel<TrabalhadorDTO> {
    ...
    public Trabalhador convertDTOToEntity() {
        return new ModelMapper().map(this, Trabalhador.class);
    }
}
